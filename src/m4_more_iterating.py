...
def run_test_count_items_bigger_than():
    ...
    sequence = [-14, 5238, -258, 52, -42, -6, 25, 3, 5, 14, -5]
    threshold = -7
    expected = 8
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    print('       actual:  ', actual)
    sequence = [2, 5, 25, 63, 25, 6, 96, 37, 8258, 5, 24, 635, 2]
    threshold = 56
    expected = 4
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    expected = 3
    actual = count_positive_sines([4, 8, 14, 22, 52])
    print()
...
def run_test_sum_first_n():
    ...
    expected = 87
    actual = sum_first_n([2,6,4,75,3,5,24], 4)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    expected = 31
    actual = sum_first_n([6,25,748,2,52], 2)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
